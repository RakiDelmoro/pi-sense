...
import cleanWaterLevelRaw from '../../../sensors/clean-water-level-raw/sensor';
import { config as cleanWaterLevelRawConfig } from '../../../sensors/clean-water-level-raw/config';
import cleanWaterTank from '../../../sensors/clean-water-tank/sensor';
import { config as cleanWaterTankConfig } from '../../../sensors/clean-water-tank/config';
...
const sensorRegistry: SensorEntry[] = [
  { slug: 'clean-water-level-raw', Component: cleanWaterLevelRaw, config: cleanWaterLevelRawConfig },
  { slug: 'clean-water-tank', Component: cleanWaterTank, config: cleanWaterTankConfig },
