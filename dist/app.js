...
function createSensorCard(sensor) {
  ...
  const displayValue = sensor.type === "doorWindow" ? reading.value === 1 ? "Closed" : "Open" : reading.value.toFixed(sensor.type === "temperature" ? 1 : 0);
...
function tickTimestamps() {
  document.querySelectorAll(".sensor-last-update").forEach((el) => {
